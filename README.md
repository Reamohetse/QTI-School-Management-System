...
- **School Fees** — track amount paid and outstanding balance per student, per course.
  - **Carpentry & Joinery, Plumbing, Electrical Installation** can each be taken on either plan:
    - Long-Term (12 months): **M1,200/month · M14,400 total**
    - Short-Term (6 months): **M1,500/month · M9,000 total**
  - **Interior Design, Leather Works & Upholstery** are fixed Short-Term: **M1,500/month · M9,000 total**
  - The study plan is chosen per student when adding/editing them.
